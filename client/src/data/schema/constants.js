export const siteUrl = "https://www.cellphonerepairtemecula.com";
export const path = "";
export const siteName = "Off The Boat Fish Grill";
export const orgName = "Off The Boat Fish Grill";
...
export const telephoneTustin = "+1714-544-1900";
export const emailTustin = "isquadrepair@gmail.com";
export const sameAsTustin = [
...
export const metaDescriptionTustin =
  "Off The Boat Fish Grill - A unique, healthy and affordable place to eat in Tustin serving delicious seafood and Mediterreanean dishes";
...
export const telephonePlacentia = "+1714-983-7550";
export const emailPlacentia = "info@offtheboatfishgrill.com";
export const sameAsPlacentia = [
