...
export function AmpIncludeAmpBodymovinAnimation() {
  return <AmpIncludeCustomElement name="amp-bodymovin-animation" version="0.1" />;
}
...
export function AmpIncludeAmpDynamicCssClasses() {
  return <AmpIncludeCustomElement name="amp-dynamic-css-classes" version="0.1" />;
}
...
export function AmpIncludeAmpGoogleDocumentEmbed() {
  return <AmpIncludeCustomElement name="amp-google-document-embed" version="0.1" />;
}
...
export function AmpIncludeAmpInstallServiceworker() {
  return <AmpIncludeCustomElement name="amp-install-serviceworker" version="0.1" />;
}
...
export function AmpIncludeAmpMinuteMediaPlayer() {
  return <AmpIncludeCustomElement name="amp-minute-media-player" version="0.1" />;
}
...
export function AmpIncludeAmpOrientationObserver() {
  return <AmpIncludeCustomElement name="amp-orientation-observer" version="0.1" />;
}
...
export function AmpIncludeAmpSubscriptionsGoogle() {
  return <AmpIncludeCustomElement name="amp-subscriptions-google" version="0.1" />;
}
...
export function AmpIncludeAmpMegaMenu() {
  return <AmpIncludeCustomElement name="amp-mega-menu" version="0.1" />;
}
